...
// Euler angles rotation matrix
float4x4 Euler4x4(float3 v)
{
	float4x4 result = (float4x4)0;
	//result._44 = 1.0f;
	result._11_22_33_44 = 1.0f;
	...
	result._11_12_13 = float3(sx*sy*sz + cy * cz, sx*sy*cz - cy * sz, cx*sy);
	result._31_32_33 = float3(sx*cy*sz - sy * cz, sx*cy*cz + sy * sz, cx*cy);
	result._21_22_23 = float3(cx*sz, cx*cz, -sx);
